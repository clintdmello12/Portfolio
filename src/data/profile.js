...
export const experience = [
  ...
  },
  {
    ...
    role: "Software Engineer",
    logo: "/assets/logos/infinite-infolab.png",
    logoText: "II",
  },
];
...
export const skills = [
  {
    group: "Engineering",
    items: [
      { name: "Java", logo: "/assets/logos/java.svg", logoText: "Jv" },
      { name: "Spring Boot", logo: "/assets/logos/spring.svg", logoText: "Sp" },
      { name: "Python", logo: "/assets/logos/python.svg", logoText: "Py" },
      { name: "Node.js", logo: "/assets/logos/nodejs.svg", logoText: "Nd" },
      { name: "React", logo: "/assets/logos/react.svg", logoText: "Re" },
      { name: "REST APIs", logo: "/assets/logos/fastapi.svg", logoText: "API" },
    ],
  },
  {
    group: "Cloud & Platform",
    items: [
      { name: "AWS", logo: "/assets/logos/aws.svg", logoText: "AWS" },
      { name: "Docker", logo: "/assets/logos/docker.svg", logoText: "Dk" },
      { name: "Kubernetes", logo: "/assets/logos/kubernetes.svg", logoText: "K8s" },
      { name: "Terraform", logo: "/assets/logos/terraform.svg", logoText: "Tf" },
      { name: "Helm", logo: "/assets/logos/helm.svg", logoText: "Hm" },
      { name: "Linux", logo: "/assets/logos/linux.svg", logoText: "Ln" },
    ],
  },
  {
    group: "Reliability",
    items: [
      { name: "SRE", logo: "/assets/logos/googlecloud.svg", logoText: "SRE" },
      { name: "CI/CD", logo: "/assets/logos/githubactions.svg", logoText: "CI" },
      { name: "Jenkins", logo: "/assets/logos/jenkins.svg", logoText: "Jk" },
      { name: "GitHub Actions", logo: "/assets/logos/githubactions.svg", logoText: "GH" },
      { name: "Prometheus", logo: "/assets/logos/prometheus.svg", logoText: "Pr" },
      { name: "ELK", logo: "/assets/logos/elastic.svg", logoText: "ELK" },
    ],
  },
  {
    group: "AI & Data",
    items: [
      { name: "RAG", logo: "/assets/logos/anthropic.svg", logoText: "RAG" },
      { name: "Claude API", logo: "/assets/logos/anthropic.svg", logoText: "AI" },
      { name: "Vector Search", logo: "/assets/logos/neo4j.svg", logoText: "VS" },
      { name: "PostgreSQL", logo: "/assets/logos/postgresql.svg", logoText: "PG" },
      { name: "MongoDB", logo: "/assets/logos/mongodb.svg", logoText: "MDB" },
      { name: "Redis", logo: "/assets/logos/redis.svg", logoText: "Rd" },
    ],
  },
];
...
export const certifications = [
  ...
  { name: "Certified BigID Associate Admin", logo: "/assets/logos/bigid.png", logoText: "BigID" },
  { name: "Certified BigID Associate Operator", logo: "/assets/logos/bigid.png", logoText: "BigID" },
  { name: "Certified Data Monetizer", logo: "/assets/logos/ydc.png", logoText: "YDC" },
];
